...
<ol class="breadcrumb">
  ...
  if($this->input->get('opt') == 'crtpay') {
    echo '<li class="active">Peminjaman Buku</li>';
  } 
  else if ($this->input->get('opt') == 'mgpay') {
    echo '<li class="active">Kelola Peminjaman</li>';
  }  
  ?>  
</ol>
  	...
  	<div class="panel-body">
  	    ...
  	    <div class="form-horizontal">
  	    	<div class="form-group">
  	    		<label for="type" class="col-sm-2 control-label">Pilih Tipe</label>
  	    		<div class="col-sm-10">
...
<div class="col-sm-3">
	<div class="panel panel-default">
		...
		<div class="list-group">
		  	<a type="button" class="list-group-item" id="managePaymentInfo">Peminjaman Buku</a>
		  	<a type="button" class="list-group-item" id="manageStudentPayInfo">Pengembalian Buku</a>
		</div>
	</div>
</div><!-- /.col-sm-3 -->
<div class="col-sm-9">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removePayment">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Hapus Peminjaman Buku</h4>
      </div>
      <div class="modal-body">
        <p>Anda yakin ingin menghapus peminjaman buku ini? </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-primary" id="removePaymentBtn">Yakin</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="editStudentPay">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      	<div class="modal-header">
        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        	<h4 class="modal-title">Edit Pengembalian Buku</h4>
      	</div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeStudentPay">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Hapus Pengembalian Buku</h4>
      </div>
      <div class="modal-body">
        <p>Anda yakin ingin menghapus pengembalian buku ini? </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-primary" id="removeStudentPayBtn">Yakin</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
